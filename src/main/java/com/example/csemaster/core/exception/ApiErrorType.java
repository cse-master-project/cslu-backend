...
public enum ApiErrorType {
    ...
    DUPLICATE_NOT_FOUND_CHAPTER(HttpStatus.BAD_REQUEST, "existing chapter", "It's a chapter that already exists"),
    ...
    ApiErrorType(HttpStatus status, String error) {
        this.status = status;
        this.error = error;
    }
    ApiErrorType(HttpStatus status, String error, String description) {
        this.status = status;
        this.error = error;
