...
import com.example.csemaster.v1.dto.request.SignUpCheckRequest;
import com.example.csemaster.v1.dto.request.SignUpRequest;
import com.example.csemaster.v1.dto.response.SignUpCheckResponse;
...
public class UserAccountController {
    ...
    public JwtInfo signUp(@RequestBody SignUpRequest request) {
        ...
        if (googleId != null) {
            ...
            throw new ApiException(ApiErrorType.INVALID_GOOGLE_TOKEN);
        }
    }
    ...
    public JwtInfo googleLogin(@RequestBody String accessToken) {
        ...
        if (googleId != null) {
            ...
            if (userId != null) {
                ...
                // 최초 등록을 하지 않은 유저
                throw new ApiException(ApiErrorType.NON_SIGN_UP);
            }
        } else {
            // 구글 액세스토큰이 유효하지 않을 경우
            throw new ApiException(ApiErrorType.INVALID_JWT);
